...
description: "Searching for information in your CRM database is something you do every day. With SuperOfficeFindyou cansearchfor a single piece of data, such as a phone number, or a list of data, such as a list of mailing recipients."
---


The following how-to guides will: Show you the different waysyou can find information in SuperOffice CRM database; Explain how you can save your searches as a selection; Demonstrate what tasks you can perform using your search or selection.
...
<Frame>
![Use the FastSearcher to navigate quick and easy in the Navigator -screenshot](https://docs.superoffice.com/media/loc/en/search-options/search-find-fastsearcher.png)
</Frame>
...
<Frame>
![You will find the free-text search in the top bar -screenshot](https://docs.superoffice.com/media/loc/en/search-options/freetext-search-box.png)
</Frame>
<Tip>
**Tip**
...
<Frame>
![Click the Find button in the top bar to get to the Find screen -screenshot](https://docs.superoffice.com/media/loc/en/search-options/find-screen.png)
</Frame>
...
<Frame>
![Click the Find button in the top bar and select typical searches in the drop-down menu -screenshot](https://docs.superoffice.com/media/loc/en/request/typical-searches-for-request.png)
</Frame>
