...
import Usagestats from "./includes/usagestats.md";
...
|assoc\_id|Optional associate, if collecting individual data|FK [associate](./associate)|&#x25CF;|
...
![UsageStats table relationship diagram](/media/loc/en/database/UsageStats.png)
