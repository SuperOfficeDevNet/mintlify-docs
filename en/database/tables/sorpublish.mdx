...
import Sorpublish from "./includes/sorpublish.md";
...
|SORTemplate\_id|Owning template|FK [SORTemplate](./sortemplate)| |
|name|Template name|String(239)| |
|nameResId|Resource ID for translatable tempalte names; otherwise 0|UInt| |
|associate\_id|Owner id; 0=SO standard template; 0xFFFFFFFF=owner is Template User (?)|FK [associate](./associate)| |
...
|defaultLabelLayout|Default template ID|FK [SORLabelLayout](./sorlabellayout)| |
...
![SORPublish table relationship diagram](/media/loc/en/database/SORPublish.png)
