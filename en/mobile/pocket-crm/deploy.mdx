...
<SOMetadata platform="pocket" deployment="onsite" />
...
[2]: ./configure
[3]: ../../onsite/security/index
[6]: ./install
[7]: ../../api/config/soformsauthentication

[img1]: ../../../media/loc/en/mobile/image.png
[img2]: ../../../media/loc/en/mobile/assign-licence.png
[img5]: ../../../media/loc/en/mobile/preferences.png
