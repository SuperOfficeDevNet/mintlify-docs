...
import NoteAppName from "./includes/note-app-name.md";
...
[4]: ../../admin/license/expander-services#tools
[5]: ../../admin/license/expander-services#development-products
[6]: ../../online/mirroring/overview
[7]: ../../online/mirroring/getting-started/create-wfc
[18]: ./request-to-publish
[17]: ./config/find-clientid
[19]: ./config/new-certificate

[img1]: ../../../media/loc/en/developer-portal/mirror-service-url.png
