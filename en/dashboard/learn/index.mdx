...
<Frame>
![Request dashboard -screenshot][img1]
</Frame>
<Note>
**Note**
...
* To **expand a tile**, click and select **View in full screen**.
	<Frame>![Tile Task menu -screenshot][img2]</Frame>
...
<Frame>
![Drill down to underlying data -screenshot][img3]
</Frame>
## Requirements
...
[img1]: ../../../media/loc/en/dashboard/dashboard-overview.png
[img2]: ../../../media/loc/en/dashboard/tile-task-menu.png
[img3]: ../../../media/loc/en/dashboard/10-drill-down.gif
