...
description: "Used to populate the Admin configuration dialog for a connection. The call to the ERP Connectorâ€™s GetConfigurationFields method returns a list of fields and field types. The Admin client builds a dialog with these fields."
...
**Returns:** [CRMScript.Global.String](CRMScript.Global.String) - Localized field name â€“ shown in the GUi.
