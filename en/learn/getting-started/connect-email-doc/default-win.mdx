...
import WhyConnectEmail from '/snippets/en/learn/getting-started/connect-email-doc/why-connect-email.mdx';
...
import SuperOfficeInboxSetup from '/snippets/en/learn/getting-started/connect-email-doc/so-inbox-for-invitations.mdx';
