...
* **Forwarding address**: <Badge color="green">Online</Badge>If you are not using the email functions in SuperOffice, emails are forwarded to this address.
* **Protocol**: <Badge color="orange">Onsite</Badge>The protocol that the mailbox uses.
