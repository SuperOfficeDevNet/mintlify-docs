...
Implemented by the `SuperOffice.Services88.IPersonAgent.SetUtmCreatedPersonContactForFormSubmission` method.

## SetUtmCreatedPersonContactForFormSubmission

[WSDL file for Services88/Person](../Services88-Person)
