...
| [ai\_chat\_turn](./ai-chat-turn) |Contains AI Chatbot history - contains whole chat, not just what is sent to the chatbot. History is ready ordered by timestamp| 462 |
...
| [AssociateHistory](./associatehistory) |Historical information about associates that have been deleted. Most references are NOT declared as foreign keys; this is a historical table that should not be updated when further changes occur in the database| 530 |
...
| [attachment\_location](./attachment-location) |A location for storing attachments| 479 |
...
| [AutomatedCategoryUpdate](./automatedcategoryupdate) |Info on how to autoupdate category when changing sale or leadstatus on person| 541 |
...
| [board\_view\_settings](./board-view-settings) |Settings for selection board view| 500 |
...
| [CacheInvalidation](./cacheinvalidation) |Names and generation numbers for distributed invalidation of caches| 531 |
...
| [CategoryFamily](./categoryfamily) |Grouping table so that multiple company categories can be grouped under one term; to simplify searching for things like &apos;all customers&apos;| 473 |
...
| [cc\_template](./cc-template) |This table contains templates for the customer center| 481 |
...
| [ConfigurableScreenAppliesTo](./configurablescreenappliesto) |Mapping between recipes in scil and chosen type of data (appliesToKey) to differ layouts on| 465 |
| [ConfigurableScreenDelta](./configurablescreendelta) |Parts of recipes in SCIL to insert or remove in given recipes| 464 |
| [ConnectionConfigField](./connectionconfigfield) |Configuration data for Erp and Quote Connections| 421 |
| [ConsentPerson](./consentperson) |Link table that defines who has which consents| 472 |
| [ConsentPurpose](./consentpurpose) |GDPR purpose alternatives| 469 |
| [ConsentSource](./consentsource) |Consent source for GDPR| 471 |
...
| [copilot](./copilot) |Contains all available copilots| 474 |
| [copilot\_data\_source](./copilot-data-source) |Stores data sources for each copilot| 475 |
| [copilot\_data\_source\_setting](./copilot-data-source-setting) |Stores specific configuration values for each data source| 476 |
...
| [cust\_config](./cust-config) |This table contains JSON structures used for customizing the customer center| 480 |
| [cust\_lang](./cust-lang) |This table contains entries for customer languages.| 320 |
| [dashboard](./dashboard) |Describes a dashboard| 482 |
| [dashboard\_theme](./dashboard-theme) |A set of style rules for the Dashboard| 483 |
| [dashboard\_tile](./dashboard-tile) |Represents one tile in the dashboard| 485 |
| [dashboard\_tile\_definition](./dashboard-tile-definition) |Describes the contents of a tile| 484 |
| [dashboard\_tile\_field](./dashboard-tile-field) |Describes the contents of a tile field| 486 |
...
| [email\_flow](./email-flow) |A set of properties related to the email workflow.| 518 |
| [email\_flow\_content\_link](./email-flow-content-link) |Links content to an email workflow| 525 |
| [email\_folder](./email-folder) |Corresponds to an email folder on a mail server| 492 |
| [email\_item](./email-item) |Email data| 494 |
| [EntityCounts](./entitycounts) |Number of different entities an associate has created for usage statistics| 538 |
...
| [external\_owner](./external-owner) |Owner of external data imported into the system| 488 |
...
| [form](./form) |A form which can be published on a webpage and submitted by visitors| 489 |
| [form\_field\_value](./form-field-value) |Form field values saved in a searchable format| 529 |
| [form\_keys](./form-keys) |Keys that makes sure a form is not posted twice| 366 |
| [form\_submission](./form-submission) |A form submission| 490 |
...
| [leadstatus](./leadstatus) |List items of lead status that is selectable for contacts and persons that have specific category| 540 |
...
| [LegalBase](./legalbase) |Legal base for GDPR (Article 6)| 470 |
...
| [MailingDomains](./mailingdomains) |List of allowed domains used in a Mailing| 498 |
...
| [obsolete\_1](./obsolete-1) |Obsolete table for functionality that was never implemented| 451 |
| [obsolete\_2](./obsolete-2) |Obsolete table for functionality that was never implemented| 452 |
| [obsolete\_3](./obsolete-3) |Obsolete table for functionality that was never implemented| 453 |
| [obsolete\_4](./obsolete-4) |Obsolete table for functionality that was never implemented| 454 |
| [OLEField](./olefield) |Control data table for the OLE DB Provider| 165 |
| [OLEFieldText](./olefieldtext) |Control data table for the OLE DB Provider| 166 |
| [OLESubject](./olesubject) |Control data table for the OLE DB Provider| 161 |
| [OLESubjectText](./olesubjecttext) |Control data table for the OLE DB Provider| 162 |
| [OLEView](./oleview) |Control data table for the OLE DB Provider| 163 |
| [OLEViewText](./oleviewtext) |Control data table for the OLE DB Provider| 164 |
| [OnlineApp](./onlineapp) |Echo and track information about Online Apps and their usage| 502 |
...
| [PushNotificationService](./pushnotificationservice) |Used for storing handles to user devices that should receive push notifications| 503 |
| [quick\_filter\_info](./quick-filter-info) |Connect quick filter info from a specific provider to a dashboard| 487 |
| [quick\_reply](./quick-reply) |Personal quick reply text fragments| 463 |
...
| [QuoteApprReason](./quoteapprreason) |Predefined reasons for quote approval| 532 |
| [QuoteApprReasonGroupLink](./quoteapprreasongrouplink) |User group link table for QuoteApprReason, for MDO item hiding| 533 |
| [QuoteApprReasonHeadingLink](./quoteapprreasonheadinglink) |Heading link table for QuoteApprReason, for MDO headers| 534 |
...
| [QuoteDenyReason](./quotedenyreason) |Predefined reasons for quote denial| 535 |
| [QuoteDenyReasonGroupLink](./quotedenyreasongrouplink) |User group link table for QuoteDenyReason, for MDO item hiding| 536 |
| [QuoteDenyReasonHeadingLink](./quotedenyreasonheadinglink) |Heading link table for QuoteDenyReason, for MDO headers| 537 |
...
| [ReporterListDef](./reporterlistdef) |Reporter definitions| 170 |
...
| [s\_messageblock](./s-messageblock) |Contains a block of a mailing message, that can be reused in a mailing| 497 |
...
| [SaintConfiguration](./saintconfiguration) |Configuration information for the Saint system| 458 |
...
| [script\_trace](./script-trace) |Scripts which should be traced| 477 |
| [script\_trace\_run](./script-trace-run) |Traces of executed scripts| 478 |
...
| [ShipmentType](./shipmenttype) |Shipment type list table. Classification of a mailing, allowing recipients to subscribe to lists| 504 |
| [ShipmentTypeReservation](./shipmenttypereservation) |ShipmentTypes a person has reserved against. Note that the absense of a record here implies acceptance of a mailings of this type| 505 |
...
| [SORCriteria](./sorcriteria) |SuperOffice reporter data| 175 |
| [SORFCT](./sorfct) |SuperOffice reporter data| 178 |
| [SORField](./sorfield) |SuperOffice reporter data| 179 |
| [SORLabelLayout](./sorlabellayout) |SuperOffice reporter data| 180 |
| [SOROperators](./soroperators) |SuperOffice reporter data| 176 |
| [SORPublish](./sorpublish) |SuperOffice reporter data| 174 |
| [SORPublishGroupLink](./sorpublishgrouplink) |Link table used for filtering reports by user group| 25 |
| [SORSection](./sorsection) |SuperOffice reporter data| 177 |
| [SORTemplate](./sortemplate) |SuperOffice reporter data| 173 |
...
| [Tags](./tags) |MDO List of tags for Service entities| 459 |
| [TagsGroupLink](./tagsgrouplink) |User group link table for Tags, for MDO item hiding| 460 |
| [TagsHeadingLink](./tagsheadinglink) |Heading link table for Source, for MDO headers| 461 |
| [target\_assignment\_info](./target-assignment-info) |Linking associate, company or user group target and other information with target values| 509 |
| [target\_assignment\_value](./target-assignment-value) |A set of values linked to assignment info and a period in a target group.| 510 |
| [target\_change](./target-change) |A single field change.| 513 |
| [target\_dimension](./target-dimension) |Defining target dimension| 514 |
| [target\_group](./target-group) |Info about a set of (sales, project, selection...) targets| 507 |
| [target\_period](./target-period) |A set of periods linked with target amounts for users/usergroups and the target groups/years.| 508 |
| [target\_revision](./target-revision) |One batch of changes made to targets| 512 |
| [target\_revision\_history](./target-revision-history) |Revision history info in case the original target group or assignment info was deleted| 511 |
...
| [TaskMenu](./taskmenu) |List items to merge into menues| 466 |
| [TaskMenuGroupLink](./taskmenugrouplink) |User group link table for TaskMenu, for MDO item hiding| 467 |
| [TaskMenuHeadingLink](./taskmenuheadinglink) |Heading link table for TaskMenu, for MDO headers| 468 |
| [temp\_db\_lock](./temp-db-lock) |Represents a temporary lock on a resource identified by table_id and key| 526 |
...
| [TemporaryKey](./temporarykey) |Temporary keys for lightweight authentications such as changing ones subscriptions| 506 |
...
| [ticket\_rel\_def\_ticket\_type](./ticket-rel-def-ticket-type) |Link table defining what Ticket types are involved in this relation. Will have M:N rows for a single relation definition| 546 |
| [ticket\_relation](./ticket-relation) |A relation between 2 tickets| 547 |
| [ticket\_relation\_def](./ticket-relation-def) |Ticket relation definition| 545 |
...
| [ticket\_type](./ticket-type) |A ticket (request) type| 542 |
| [ticket\_type\_priority](./ticket-type-priority) |Link table defining what Priorities are relevant to a particular Ticket type| 543 |
| [ticket\_type\_status](./ticket-type-status) |Link table defining what Statuses are relevant to a particular Ticket type| 544 |
| [time\_keeping](./time-keeping) |Time keeping for how much time a sale or project or other entity has spent in a given stage or other state| 501 |
...
| [TypicalSearch](./typicalsearch) |Owner of a set of predefined selection criteria| 499 |
...
| [UsageStats](./usagestats) |Usage statistics| 190 |
...
| [utm\_parameters](./utm-parameters) |Table for utm parameters collected from visits and formsubmissions| 539 |
...
| [Webhook](./webhook) |Webhook URL to call when events occur in the client or in NetServer. Also tracks call+error statistics.| 515 |
| [Webhook\_usage](./webhook-usage) |Webhook usage statistics - tracks call+error statistics. Same primary key as the webhook.| 516 |
...
| [workflow](./workflow) |SuperOffice specific info about a workflow| 517 |
| [workflow\_goal](./workflow-goal) |A set of goals related to a workflow. Some goals will have search criterias associated with it to determine if the goal has been reached.| 520 |
| [workflow\_instance](./workflow-instance) |A set of properties related to the workflow instance of one participant going through the flow| 519 |
| [workflow\_root\_step\_link](./workflow-root-step-link) |Link root steps to the workflow| 528 |
| [workflow\_step](./workflow-step) |A set of steps related to a workflow.| 521 |
| [workflow\_step\_option](./workflow-step-option) |Some steps can have optional child &apos;flows&apos;, a new series of steps| 523 |
| [workflow\_step\_option\_link](./workflow-step-option-link) |Link steps to other steps through step options| 524 |
| [workflow\_trigger](./workflow-trigger) |A set of triggers related to a workflow.| 522 |
| [workflow\_wait\_for\_action](./workflow-wait-for-action) |Some steps wait for actions, this is info about those actions| 527 |
