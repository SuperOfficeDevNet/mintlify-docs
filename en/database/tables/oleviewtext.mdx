...
import Oleviewtext from "./includes/oleviewtext.md";
...
|OLEView\_id|OLE View|FK [OLESubject](./olesubject)| |
...
![OLEViewText table relationship diagram](/media/loc/en/database/OLEViewText.png)
