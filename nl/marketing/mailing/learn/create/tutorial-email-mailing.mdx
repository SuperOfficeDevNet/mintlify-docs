...
import TipMailingSaveDraft from "./includes/tip-mailing-save-draft.md";
import SpfLookUp from "./includes/spf-look-up.md";
import MailingTrackingOptions from "./includes/mailing-tracking-options.md";
import MailingChooseTemplate from "./includes/mailing-choose-template.md";
import Step3ContentEmail from "./includes/step-3-content-email.md";
import Step4Recipients from "./includes/step-4-recipients.md";
