...
import Sorfield from "./includes/sorfield.md";
...
|SORSection\_id|Foreign key to Section|FK [SORSection](./sorsection)| |
...
![SORField table relationship diagram](/media/loc/en/database/SORField.png)
