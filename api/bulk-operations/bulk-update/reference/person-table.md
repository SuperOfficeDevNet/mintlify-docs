    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <p>Deletes a record in the MailingTypeReservation table
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                ...
                <p>Values[0] = (int) MailingTypeId</p>
                <p>Adds a record to the MailingTypeReservation table
            </td>
