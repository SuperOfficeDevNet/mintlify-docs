...
* [Modify table CacheTables](../../en/database/tables/cachetables.md)
subKeyId
* [Modify table ImportRelation](../../en/database/tables/importrelation.md)
foreignKey
...
* [Modify table person](../../en/database/tables/person.md)
* [Modify table phone](../../en/database/tables/phone.md)

**Step 19**

Add fields and attributes to support the Soft Delete feature on person and contact tables

* [Modify table Contact](../../en/database/tables/contact.md)
DeletedDate
* [Modify table Person](../../en/database/tables/person.md)
DeletedDate
...
* [Add table SaintConfiguration](../../en/database/tables/saintconfiguration.md)
* [Modify table StatusDef](../../en/database/tables/statusdef.md)
...
* [Modify table Associate](../../en/database/tables/associate.md)
userName
...
* [Modify table PrefDesc](../../en/database/tables/prefdesc.md)
...
* [Add table Tags](../../en/database/tables/tags.md)
* [Add table TagsGroupLink](../../en/database/tables/tagsgrouplink.md)
* [Add table TagsHeadingLink](../../en/database/tables/tagsheadinglink.md)
...
* [Modify table appointment](../../en/database/tables/appointment.md)
do\_By, done, endDate, activeDate
* [Modify table recurrenceRule](../../en/database/tables/recurrencerule.md)
startDate, endDate
* [Modify table email\_folder](../../en/database/tables/email-folder.md)
name
...
* [Modify table DocTmpl](../../en/database/tables/doctmpl.md)
...
* [Modify table SuperListColumnSize](../../en/database/tables/superlistcolumnsize.md)
...
* [Add table AssociateHistory](../../en/database/tables/associatehistory.md)

**Step 45**

Add a field snum to table document, and cautionWarning to appointment

* [Modify table Document](../../en/database/tables/document.md)
snum
* [Modify table Appointment](../../en/database/tables/appointment.md)
cautionWarning
...
* [Modify table ej\_message](../../en/database/tables/ej-message.md)
...
* [Modify table searchcriterionvalue](../../en/database/tables/searchcriterionvalue.md)
...
* [Modify table ticket](../../en/database/tables/ticket.md)
* [Modify table ej\_message](../../en/database/tables/ej-message.md)
time\_spent, time\_charge
* [Modify table invoice](../../en/database/tables/invoice.md)
time\_charged
* [Modify table ticket\_priority](../../en/database/tables/ticket-priority.md)
deadline
* [Modify table ticket\_status\_history](../../en/database/tables/ticket-status-history.md)
timespan, real\_timespan
* [Modify table appointment](../../en/database/tables/appointment.md)
done, do\_by, activeDate, endDate
* [Modify table text](../../en/database/tables/text.md)
updatedCount
...
* [Modify table freetextwords](../../en/database/tables/freetextwords.md)
word, soundEx
* [Modify table freetextindex](../../en/database/tables/freetextindex.md)
contact\_id
...
* [Modify table chat\_topic](../../en/database/tables/chat-topic.md)
* [Modify table chat\_topic\_user](../../en/database/tables/chat-topic-user.md)
can\_respond, notifications, can\_listen, manager
* [Modify table chat\_session](../../en/database/tables/chat-session.md)
name, company\_name, email, phone, first\_message, last\_message, flags
* [Modify table chat\_message](../../en/database/tables/chat-message.md)
created\_by
* [Modify table ejuser](../../en/database/tables/ejuser.md)
chat\_status
...
* [Modify table chat\_topic](../../en/database/tables/chat-topic.md)
widget\_language
* [Modify table cust\_lang](../../en/database/tables/cust-lang.md)
iso\_code
...
* [Modify table config](../../en/database/tables/config.md)
feature\_toggle

**Step 4**

* [Modify table login\_customer](../../en/database/tables/login-customer.md)
created\_at
* [Add table quick\_reply](../../en/database/tables/quick-reply.md)
...
* [Modify table category](../../en/database/tables/category.md)
family\_id
...
* [Add table ConsentPurpose](../../en/database/tables/consentpurpose.md)
* [Add table LegalBase](../../en/database/tables/legalbase.md)
* [Add table ConsentSource](../../en/database/tables/consentsource.md)
* [Add table ConsentPerson](../../en/database/tables/consentperson.md)
* [Add table CategoryFamily](../../en/database/tables/categoryfamily.md)
* [Modify table DocTmpl](../../en/database/tables/doctmpl.md)
...
* [Modify table outbox](../../en/database/tables/outbox.md)
rfc822\_content

**Step 10**

* [Modify table ConsentPerson](../../en/database/tables/consentperson.md)

**Step 11**

* [Modify table ConsentPerson](../../en/database/tables/consentperson.md)
* [Modify table ConsentPerson](../../en/database/tables/consentperson.md)
* [Modify table ShipmentTypeReservation](../../en/database/tables/shipmenttypereservation.md)
* [Modify table ConsentPurpose](../../en/database/tables/consentpurpose.md)
* [Modify table ConsentSource](../../en/database/tables/consentsource.md)
* [Modify table LegalBase](../../en/database/tables/legalbase.md)
* [Modify table ShipmentType](../../en/database/tables/shipmenttype.md)

**Step 12**

* [Modify table ErpConnection](../../en/database/tables/erpconnection.md)
...
* [Add table script\_trace](../../en/database/tables/script-trace.md)
* [Add table script\_trace\_run](../../en/database/tables/script-trace-run.md)
* [Modify table screen\_chooser](../../en/database/tables/screen-chooser.md)
description, enabled

**Step 2**

* [Modify table ejscript](../../en/database/tables/ejscript.md)
extra\_menus\_id
...
* [Modify table screen\_definition](../../en/database/tables/screen-definition.md)
autosave
...
* [Modify table s\_message](../../en/database/tables/s-message.md)
long\_description

**Step 4**

* [Modify table ticket\_status](../../en/database/tables/ticket-status.md)
status
* [Modify table ticket\_priority](../../en/database/tables/ticket-priority.md)
status, flags, ticket\_read, changed\_owner, ticket\_newinfo, ticket\_closed, ticket\_changed\_priority, ticket\_new
* [Modify table ej\_category](../../en/database/tables/ej-category.md)
...
* [Modify table s\_list\_element](../../en/database/tables/s-list-element.md)
status
...
* [Add table attachment\_location](../../en/database/tables/attachment-location.md)
* [Modify table attachment](../../en/database/tables/attachment.md)
...
* [Modify table mail\_in\_filter](../../en/database/tables/mail-in-filter.md)
mailgun\_dsn
...
* [Modify table ticket\_log\_action](../../en/database/tables/ticket-log-action.md)
details
...
* [Add table cust\_config](../../en/database/tables/cust-config.md)
...
* [Add table form](../../en/database/tables/form.md)
* [Add table form\_submission](../../en/database/tables/form-submission.md)

**Step 2**

* [Modify table form](../../en/database/tables/form.md)
...
* [Modify table form\_submission](../../en/database/tables/form-submission.md)
is\_submitted
...
* [Add table email\_account](../../en/database/tables/email-account.md)
* [Add table email\_folder](../../en/database/tables/email-folder.md)
* [Add table service\_auth](../../en/database/tables/service-auth.md)
* [Add table email\_item](../../en/database/tables/email-item.md)

**Step 2**

* [Modify table email\_item](../../en/database/tables/email-item.md)

**Step 3**

* [Modify table email\_item](../../en/database/tables/email-item.md)
replied\_at, in\_reply\_to, messageId
* [Modify table email\_account](../../en/database/tables/email-account.md)
default
...
* [Modify table email\_item](../../en/database/tables/email-item.md)
cc
* [Modify table service\_auth](../../en/database/tables/service-auth.md)
associate\_id, auth\_status

**Step 5**

* [Modify table timestamps](../../en/database/tables/timestamps.md)
mailsync
...
* [Modify table email\_item](../../en/database/tables/email-item.md)
* [Add table email\_attachment](../../en/database/tables/email-attachment.md)
...
* [Add table invitation](../../en/database/tables/invitation.md)
* [Modify table email](../../en/database/tables/email.md)
appointment\_id
...
* [Modify table invitation](../../en/database/tables/invitation.md)
...
* [Modify table erpexternalkey](../../en/database/tables/erpexternalkey.md)
...
* [Modify table s\_shipment](../../en/database/tables/s-shipment.md)
sorting
...
* [Modify table s\_message](../../en/database/tables/s-message.md)
design, designtype
* [Add table s\_messageblock](../../en/database/tables/s-messageblock.md)
* [Modify table s\_message](../../en/database/tables/s-message.md)
flags
...
* [Modify table s\_shipment](../../en/database/tables/s-shipment.md)
status
* [Modify table s\_link\_customer](../../en/database/tables/s-link-customer.md)
link\_type
* [Modify table s\_link\_customer\_statical](../../en/database/tables/s-link-customer-statical.md)
link\_type
...
* [Add table TypicalSearch](../../en/database/tables/typicalsearch.md)

**Step 4**

Cleanup 'temporary selection' marking by introducing the IsTemporary field

* [Modify table selection](../../en/database/tables/selection.md)
SystemType
...
* [Add table OnlineApp](../../en/database/tables/onlineapp.md)
* [Modify table userpreference](../../en/database/tables/userpreference.md)
* [Modify table userpreference](../../en/database/tables/userpreference.md)

## Optimization

* [Modify table TravelTransactionLog](../../en/database/tables/traveltransactionlog.md)
* [Modify table ForeignKey](../../en/database/tables/foreignkey.md)
...
* [Add table PushNotificationService](../../en/database/tables/pushnotificationservice.md)

**Step 2**

* [Modify table PushNotificationService](../../en/database/tables/pushnotificationservice.md)
Language
...
* [Modify table Favourite](../../en/database/tables/favourite.md)
Rank
...
* [Modify table login](../../en/database/tables/login.md)
flags
...
* [Add table TemporaryKey](../../en/database/tables/temporarykey.md)
...
* [Add table Webhook](../../en/database/tables/webhook.md)
