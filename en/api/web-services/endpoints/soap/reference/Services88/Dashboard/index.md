...
Handled by the `SuperOffice.Services88.IDashboardAgent` interface.

Download [WSDL file for Services88/Dashboard](../Services88-Dashboard) if you need to generate your own proxy code.
