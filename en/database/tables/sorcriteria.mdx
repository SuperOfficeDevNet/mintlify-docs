...
import Sorcriteria from "./includes/sorcriteria.md";
...
|SORPublish\_id|Owning publish name|FK [SORPublish](./sorpublish)| |
|fieldName|Database field name|String(29)| |
|SOROperators\_id|Operator foreign key|FK [SOROperators](./soroperators)| |
...
![SORCriteria table relationship diagram](/media/loc/en/database/SORCriteria.png)
