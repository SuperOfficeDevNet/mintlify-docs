...
import Olefieldtext from "./includes/olefieldtext.md";
...
|OLEField\_id|OLE View|FK [OLESubject](./olesubject)| |
...
![OLEFieldText table relationship diagram](/media/loc/en/database/OLEFieldText.png)
