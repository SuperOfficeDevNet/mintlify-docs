...
| Table no | 7.1 | 7.5 |
|---|---|---|
| 25 | `obsolete_1` | [SORPublishGroupLink](../../en/database/tables/sorpublishgrouplink.md) |
| 26 | `obsolete_2` | [QuoteConnection](../../en/database/tables/quoteconnection.md) |
| 27 | `obsolete_3` | [QuoteConnectionAccess](../../en/database/tables/quoteconnectionaccess.md) |
| 34 | `obsolete_4` | [Quote](../../en/database/tables/quote.md) |
| 39 | `obsolete_9` | [QuoteVersion](../../en/database/tables/quoteversion.md) |
| 47 | `obsolete_5` | [QuoteAlternative](../../en/database/tables/quotealternative.md) |
| 127 | `obsolete_6` | [QuoteLine](../../en/database/tables/quoteline.md) |
| 128 | `obsolete_7` | [PriceList](../../en/database/tables/pricelist.md) |
| 129 | `obsolete_8` | [Product](../../en/database/tables/product.md) |

## New tables

| Table no | Name |
|---|---|
| 408 | [ProductCategory](../../en/database/tables/productcategory.md) |
| 409 | [ProductCategoryGroupLink](../../en/database/tables/productcategorygrouplink.md) |
| 410 | [ProductCategoryHeadingLink](../../en/database/tables/productcategoryheadinglink.md) |
| 411 | [ProductFamily](../../en/database/tables/productfamily.md) |
| 412 | [ProductFamilyGroupLink](../../en/database/tables/productfamilygrouplink.md) |
| 413 | [ProductFamilyHeadingLink](../../en/database/tables/productfamilyheadinglink.md) |
| 414 | [ProductType](../../en/database/tables/producttype.md) |
| 415 | [ProductTypeGroupLink](../../en/database/tables/producttypegrouplink.md) |
| 416 | [ProductTypeHeadingLink](../../en/database/tables/producttypeheadinglink.md) |
| 417 | [ErpConnector](../../en/database/tables/erpconnector.md) |
| 418 | [ErpConnection](../../en/database/tables/erpconnection.md) |
| 419 | [ErpConnectionActorType](../../en/database/tables/erpconnectionactortype.md) |
| 420 | [ErpConnectionAccess](../../en/database/tables/erpconnectionaccess.md) |
| 421 | [ConnectionConfigField](../../en/database/tables/connectionconfigfield.md) |
| 422 | [ErpInternalKey](../../en/database/tables/erpinternalkey.md) |
| 423 | [ErpExternalKey](../../en/database/tables/erpexternalkey.md) |
| 424 | [ErpListItemMapping](../../en/database/tables/erplistitemmapping.md) |
| 425 | [ErpField](../../en/database/tables/erpfield.md) |
| 426 | [ErpSyncLog](../../en/database/tables/erpsynclog.md) |
| 427 | [PaymentTerms](../../en/database/tables/paymentterms.md) |
| 428 | [PaymentTermsGroupLink](../../en/database/tables/paymenttermsgrouplink.md) |
| 429 | [PaymentTermsHeadingLink](../../en/database/tables/paymenttermsheadinglink.md) |
| 430 | [PaymentType](../../en/database/tables/paymenttype.md) |
| 431 | [PaymentTypeGroupLink](../../en/database/tables/paymenttypegrouplink.md) |
| 432 | [PaymentTypeHeadingLink](../../en/database/tables/paymenttypeheadinglink.md) |
| 433 | [DeliveryTerms](../../en/database/tables/deliveryterms.md) |
| 434 | [DeliveryTermsGroupLink](../../en/database/tables/deliverytermsgrouplink.md) |
| 435 | [DeliveryTermsHeadingLink](../../en/database/tables/deliverytermsheadinglink.md) |
| 436 | [DeliveryType](../../en/database/tables/deliverytype.md) |
| 437 | [DeliveryTypeGroupLink](../../en/database/tables/deliverytypegrouplink.md) |
| 438 | [DeliveryTypeHeadingLink](../../en/database/tables/deliverytypeheadinglink.md) |
| 439 | [PriceUnit](../../en/database/tables/priceunit.md) |
| 440 | [PriceUnitGroupLink](../../en/database/tables/priceunitgrouplink.md) |
| 441 | [PriceUnitHeadingLink](../../en/database/tables/priceunitheadinglink.md) |
| 442 | [SubscriptionUnit](../../en/database/tables/subscriptionunit.md) |
| 443 | [SubscriptionUnitGroupLink](../../en/database/tables/subscriptionunitgrouplink.md) |
| 444 | [SubscriptionUnitHeadingLink](../../en/database/tables/subscriptionunitheadinglink.md) |
| 445 | [QuoteLineConfiguration](../../en/database/tables/quotelineconfiguration.md) |
| 446 | [SaleTypeQuoteAttachment](../../en/database/tables/saletypequoteattachment.md) |
| 447 | [QuoteVersionAttachment](../../en/database/tables/quoteversionattachment.md) |
| 448 | [ResourceOverride](../../en/database/tables/resourceoverride.md) |
| 449 | [ErpConfiguration](../../en/database/tables/erpconfiguration.md) |
| 450 | [EjCategoryGroupLink](../../en/database/tables/ejcategorygrouplink.md) |

## New fields on existing tables

### [Contact](../../en/database/tables/contact.md)

| Field | Type | Description |
|---|---|---|
| `ActiveErpLinks` | long | <ActiveerplinksDescr /> |

### [Person](../../en/database/tables/person.md)

| Field | Type | Description |
|---|---|---|
| `ActiveErpLinks` | long | <ActiveerplinksDescr /> |

### [Project](../../en/database/tables/project.md)

| Field | Type | Description |
|---|---|---|
| `ActiveErpLinks` | long | <ActiveerplinksDescr /> |

### [Sale](../../en/database/tables/sale.md)

| Field | Type | Description |
|---|---|---|
| `ActiveErpLinks` | long | <ActiveerplinksDescr /> |

### [Currency](../../en/database/tables/currency.md)

| Field | Type | Description |
|---|---|---|
| `isoCode` | VarWChar | [ISO currency code][1] |

### [DocTmpl](../../en/database/tables/doctmpl.md)
...
### [SaleType](../../en/database/tables/saletype.md)
...
### [Role](../../en/database/tables/role.md)

| Field | Type | Description |
|---|---|---|
| `use_categories` | ushort | Override user categories with role categories (CS role) |

### [ej\_category](../../en/database/tables/ej-category.md)
...
### [ticket\_status](../../en/database/tables/ticket-status.md)
...
### [mail\_in\_filter](../../en/database/tables/mail-in-filter.md)
...
### [role\_category](../../en/database/tables/role-category.md)

| Field | Type | Description |
|---|---|---|
| `crm_role` | longid | Link to Role |

### [role\_element](../../en/database/tables/role-element.md)

| Field | Type | Description |
|---|---|---|
| `crm_role` | longid | Link to Role |

### [role\_workflow](../../en/database/tables/role-workflow.md)

| Field | Type | Description |
|---|---|---|
| `crm_role` | longid | Link to Role |

### [s\_shipment](../../en/database/tables/s-shipment.md)

| Field | Type | Description |
|---|---|---|
| `envelope_from[256]` | wchar\_t | Email address for the MTA envelope (where bounces are returned) |

### [s\_link](../../en/database/tables/s-link.md)
...
### [s\_link\_customer](../../en/database/tables/s-link-customer.md)

| Field | Type | Description |
|---|---|---|
| `http_user_agent[256]` | wchar\_t | The HTTP\_USER\_AGENT reported when the customer opened this link |

### [s\_link\_customer\_statical](../../en/database/tables/s-link-customer-statical.md)

| Field | Type | Description |
|---|---|---|
| `http_user_agent[256]` | wchar\_t | The HTTP\_USER\_AGENT reported when the customer opened this link |

### [s\_shipment\_addr](../../en/database/tables/s-shipment-addr.md)
