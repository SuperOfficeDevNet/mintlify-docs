...
import NoteVisibility from "./includes/note-visibility.md";
...
[img1]: ../../media/loc/en/integrations/outlook-save-to-superoffice.png
[img2]: ../../media/loc/en/integrations/outlook-send-and-archive.png
