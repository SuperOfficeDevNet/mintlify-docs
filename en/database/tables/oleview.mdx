...
import Oleview from "./includes/oleview.md";
...
|OLESubject\_id|Owner subject|FK [OLESubject](./olesubject)| |
...
![OLEView table relationship diagram](/media/loc/en/database/OLEView.png)
