...
Handled by the `SuperOffice.Services88.IReplicationAgent` interface.

Download [WSDL file for Services88/Replication](../Services88-Replication) if you need to generate your own proxy code.
