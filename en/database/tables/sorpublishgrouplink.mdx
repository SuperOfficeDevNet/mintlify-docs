...
import Sorpublishgrouplink from "./includes/sorpublishgrouplink.md";
...
|SORPublishId|Report to link to a group|FK [SORPublish](./sorpublish)|&#x25CF;|
|UserGroupId|Group that should be able to see this report|FK [UserGroup](./usergroup)|&#x25CF;|
...
![SORPublishGroupLink table relationship diagram](/media/loc/en/database/SORPublishGroupLink.png)
