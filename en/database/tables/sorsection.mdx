...
import Sorsection from "./includes/sorsection.md";
...
|SORTemplate\_id|Template ID|FK [SORTemplate](./sortemplate)| |
...
![SORSection table relationship diagram](/media/loc/en/database/SORSection.png)
