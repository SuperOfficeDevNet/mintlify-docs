    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>add:<br/>Creates and adds all values as RelationRows
                <p>remove:<br/>Deletes all similar relations
                <p>ReplaceWith:<br/>Deletes all similar relations, then adds back new ones
                <p>Clear: deletes all existing relations
            </td>
            <td>
                <p>LinksHelper</p>
            </td>
        ...
        <tr>
            ...
            <td>
                <p>Values Count = 1</p>
                <p>Values[0] = (datetime) <br/>Only changes Date. Times are changed via StartTime field
            </td>
